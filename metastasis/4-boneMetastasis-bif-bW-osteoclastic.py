...
PCargs.MinStepSize  = 0.4
PCargs.StepSize     = 0.4
PCargs.MaxStepSize  = 0.4
...
plt.xlabel('$\\beta_{W}$',fontsize=18)
...
plt.tight_layout()
plt.savefig("met-bif-bW-osteoclastic.pdf")