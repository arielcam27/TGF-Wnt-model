...
state, control, time = myControl(249, 1, 0.0, 1, 0, 0.5, 0.05)
plotResults(state, control, time)
plt.savefig("control-met-2-inter-1.pdf")

state, control, time = myControl(2, 12, 0.0, 1, 0, 0.5, 0.05)
plotResults(state, control, time)
plt.savefig("control-met-2-inter-2.pdf")

x, bis, tgf, wnt, chm, xC, xB, xT, xW, BM, xM = extract_ctrl('met-2-sol')
...
plt.savefig("control-met-2-optimal-1.pdf")
...
plt.savefig("control-met-2-chm.pdf")
...
ax.set_position([box.x0, box.y0, box.width * 0.65, box.height])
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("control-met-2-wnt.pdf")